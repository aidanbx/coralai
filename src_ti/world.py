...
class World:
    ...
    def _index_subchannels(self, subchdict, start_index, parent_chid):
        ...
        for subchid, subch in subchdict.items():
            ...
            self.ti_lims_builder.add_nparr_float(parent_chid + "_" + subchid, self.channels[parent_chid].lims)
            subch_tree[subchid] = {
                'indices': indices,
            }
        ...
        def _get_tuple_indices(self, key_tuple):
            ...
            if isinstance(subchid, list):
                ...
                for subchid_single in key_tuple[1]:
                    indices += self.index_tree[chid]['subchannels'][subchid_single]['indices']
            else:
