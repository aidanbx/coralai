...
from eincasm.World import World
from eincasm.Eincasm import eincasm as Eincasm
...
class Vis:
    ...
    def render_opt_window(self, vars):
        ...
        with self.gui.sub_window("Options", 0.05, 0.05, opt_w, opt_h) as w:
            ...
            v.is_perturbing_weights = w.checkbox("Perturb Weights", v.is_perturbing_weights)
            v.is_perturbing_biases = w.checkbox("Perturb Biases", v.is_perturbing_biases)
