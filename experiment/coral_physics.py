...
from coralai.utils import ch_norm



def apply_all_physics(substrate, kernel, max_infra, max_energy):
    activate_outputs(substrate)
    invest_liquidate(substrate)
    explore_physics(substrate, kernel, max_infra, max_energy)
    energy_physics(substrate, kernel, max_infra, max_energy)
