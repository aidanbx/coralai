...
importlib.reload(eincasm_config)


def activate_muscles_and_flow(cfg: eincasm_config, capital: torch.Tensor, muscle_radii: torch.Tensor,
...
def generate_muscle_masks(cfg: eincasm_config, open_cells: torch.Tensor) -> torch.Tensor:
...
def grow_muscle_csa(cfg: eincasm_config, muscle_radii: torch.Tensor, radii_deltas: torch.Tensor,
